...
class ax25_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.samp_rate_0 = samp_rate_0 = 48e6
        ...
        self._BW_range = Range(0, 200000000, 1, 200000, 200)
        self._BW_win = RangeWidget(self._BW_range, self.set_BW, "'BW'", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/girinath/RF Lab/CubeSat Telemetry/V2/TX/packet.wav', True)
