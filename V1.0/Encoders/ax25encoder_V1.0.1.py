...
telemetry = input("\nEnter Telemetry Message: ")

# ============================================================
# AX.25 FRAME CREATION
# ============================================================
...
# 50 FLAGS PREAMBLE + POSTAMBLE
preamble_flags = 50

result = (
    FLAG * preamble_flags
    + stuffedbody
    + END_FLAG * preamble_flags
)
...
print("\nBits:", len(nrzi_bits))
print("Duration:", len(nrzi_bits) / BIT_RATE, "seconds")
